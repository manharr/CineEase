...
if (isset($_GET['id'])) {
    ...
    // Fetch showtimes and theatre names for the specified movie ID
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ?>
        <div class="container">
            <h2>Showtimes for <?php echo htmlspecialchars($movie['mv_name']); ?></h2>
        ...
        echo "<div class='container'><h3>No showtimes found for this movie.</h3></div>";
    }
} else {
