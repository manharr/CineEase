  ...
  <div class="col-sm-6">
    ...
    <div class="card text-center">
      <div class="card-body" style="background-color: #8ab593;">
        <h5 class="card-title">Total No. Of Movies in <?php echo $row1['category_name']; ?></h5>
         <?php 
      $id = $row1['id'];
      ...
      if ($run2) {
       ...
       ?>
        <a href="viewpost.php?id=<?php echo$row1['id'] ?>" class="btn btn-outline-info">View Movies</a>
      </div>
    </div>
  </div>
  <?php
    ...
    <div class="card text-center">
      ...
      if ($run5) {
       while ($row5 = mysqli_fetch_assoc($run5)) {
                  ...
                  ?>
        <p class="card-text">No. of Movies "<?php echo $row5['total_post']; ?>"</p>
